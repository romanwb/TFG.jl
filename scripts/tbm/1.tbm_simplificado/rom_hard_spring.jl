using HBMContinuation, GLMakie, LinearAlgebra, Julianim, CairoMakie
...
Aⱼ, Xⱼ, Ω = solver_HBM(γ, rom_str, ContPars, HBMCPars, X_init, Ω₀)

range_dof(dof::Integer, H::Integer) = ((dof-1)*(2H + 1) + 1):(dof*(2H + 1))
...
fig, ax = make_figure(L"|x_1(t)|")
lines!(ax, Ω, x₁_max)
display(GLMakie.Screen(), fig)
save("figures/rom/hard_spring/amp_x1.pdf", fig; backend=CairoMakie)
