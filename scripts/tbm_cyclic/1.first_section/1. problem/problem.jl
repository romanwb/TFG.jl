...
p = (
 ...
 @save "scripts/tbm/3.turbine_blade_model/1.first_section/H$(H)" Ω Xⱼ Aⱼ p


H = 5
     @load "scripts/tbm/3.turbine_blade_model/1.first_section/H$(H)" Ω Xⱼ Aⱼ p
